...
from safari_bookmark_organizer.safari_io import (
    SafariBookmarkItem,
    SafariBookmarks,
)
...
class TestSafariBookmarkItem:
    ...
    def test_remove_error(self, request, list_item, fixture):
        item = request.getfixturevalue(fixture)
        list_item._node.children.append(item._node)
...
class TestSafariBookmarks:
        ...
        return WebBookmarkTypeList(
                    ...
                    Children=[
                        WebBookmarkTypeLeaf(
                            ...
                            ReadingList={
                                ...
                                "PreviewText": (
                                    "Linux From Scratch Version r11.0-199 Published February"
                                    " 26th, 2022 Created by Gerard Beekmans Managing Editor:"
                                    " Bruce Dubbs Copyright \u00a9 1999-2022 Gerard Beekmans"
                                    " Table of Contents Preface Foreword Audience LFS Target A"
                                ),
                            },
                            imageURL="",
                        ),
                        WebBookmarkTypeLeaf(
                            ...
                            ReadingList={
                                ...
                                "PreviewText": (
                                    "Learn how to create colorful, generative grid designs"
                                    " with JavaScript and SVG!"
                                ),
                            },
                            imageURL=(
                                "https://frontend.horse/static/"
                                "d70d16675d20860a230a6b1e76dfba62/share.png"
                            ),
                        ),
                    ],
            ...
            Sync={
                "CloudKitDeviceIdentifier": (
                    "06E15A3A03BD93165AE80C02E19C86CD1E52B84F8DA8BE82B889CD2DCE0B2279"
                ),
    ...
    def test_load__error(self, path: Path, binary: bool):
        with (
            ...
            # Intentionally passing text-mode file to verify it raises IOError
            SafariBookmarks.load(file, binary=binary)  # ty: ignore[invalid-argument-type]
    ...
    def test_dump(self, digest: str, binary: bool, subject):
        with BytesIO() as buf:
            ...
            buf.seek(0)
            assert digest == hashlib.sha1(buf.read()).hexdigest()  # noqa: S324
